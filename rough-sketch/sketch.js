...
function initGuns() {
  ...
  // //temp gun
  // ak47 = new guns.Sprite(player.x + 400, player.y);
  // ak47.removeColliders();
  // ak47.layer = 2;
  // ak47.bulletArray = [];
  // ak47.gunType = "ak47";
  // ak47.range = 70;
  ...
  // // ak47.stashed = false;
  // // ak47.equipped = false;
  // ak47.inInventory = false;

  // ak47.stash = function() {
  //   this.stashed = true;
  // }
  
  // ak47.isEquipped = function()   {
  //   this.img = pistolImg;
  //   this.layer = 6;
  //   this.offset.x = 33;
  //   this.scale = 0.6;
  ...
  //   // this.bulletArray.push(bullet);
  // }
  // ak47.updateWhileEquipped = function() {
  //   this.x = this.owner.x;
  //   this.y = this.owner.y;
  //   if(this.owner === player) {
  //     this.rotateTowards(mouse, 1.2, 1)
  ...
  // uzi = new guns.Sprite(player.x + 300, player.y);
  // uzi.removeColliders();
  // uzi.layer = 2;
  // uzi.bulletArray = [];
  // uzi.gunType = "ak47";
  ...
  // // ak47.stashed = false;
  // // ak47.equipped = false;
  // uzi.inInventory = false;

  // uzi.stash = function() {
  //   this.stashed = true;
  // }
  
  // uzi.isEquipped = function()   {
  //   this.img = pistolImg;
  //   this.layer = 6;
  //   this.offset.x = 33;
  //   this.scale = 0.6;
  ...
  //   // this.bulletArray.push(bullet);
  // }
  // uzi.updateWhileEquipped = function() {
  //   this.x = this.owner.x;
  //   this.y = this.owner.y;
  //   if(this.owner === player) {
  //     this.rotateTowards(mouse, 1.2, 1)
